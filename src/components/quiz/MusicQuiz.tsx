        ...
        {displayedArtists.map((artist) => (
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 rounded-full overflow-hidden mb-3 shadow-lg">
              ...
              />
              {selectedArtists.includes(artist.id) && (
                <div className="absolute inset-0 bg-gradient-to-br from-cultura-primary-600/90 to-cultura-accent-600/90 flex items-center justify-center rounded-full backdrop-blur-sm">
            ...
            <p className="text-sm text-cultura-primary-600 text-center font-medium">{artist.category}</p>
          </div>
        ))}
      </div>
