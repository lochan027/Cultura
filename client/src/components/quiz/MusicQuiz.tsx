    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {displayedArtists.map((artist) => (
          ...
          >
            <div className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 rounded-full overflow-hidden mb-3 shadow-lg relative">
              <img
                src={artist.image}
                alt={artist.title}
              ...
              {selectedArtists.includes(artist.id) && (
                <>
                  <div className="absolute inset-0 bg-gradient-to-br from-cultura-purple-600/80 to-cultura-pink-600/80 flex items-center justify-center rounded-full">
